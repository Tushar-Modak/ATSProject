    ...
    <?php echo '<div class="inmidpanel">'?>
    	...
    	<?php echo'</div>
    	 ...
    	 <div class="inpanelsec">
    		<h3 class="inpanelname">'?><?php echo $outputName[$i];?><?php echo '</h3>'?>
			<?php 
			if($_SESSION["favorite"][$i]==2)
			{?>
    		<?php echo '<img src="Fav/liked.png" class="inpanelfav">'?><?php }?>
			<?php 
			if($_SESSION["favorite"][$i]==3)
			{?>
    		<?php echo '<img src="Fav/like.png" class="inpanelfav">'?><?php }?>
    		...
    		<a href="Menu.php"><input type="button" name="showmenu" value="Show Menu" class="showmenu"></a>
    	 </div>
